...
(function () {
  ...
  ejs.FiltersAggregation = function (name) {
    ...
    return extend(_common, {
      ...
      @param {Filter} oFilter A valid <code>Filters</code> object.
      @returns {Object} returns <code>this</code> so that calls can be chained.
      */
      filters: function (oFilters) {
        ...
        //   filters.filters['q_' + oFilters[i].id] = oFilters[i].toJSON();
        // }

        filters.filters = oFilters;
  ...
  ejs.Request = function (conf) {
    ...
    return {
      ...
      aggregation: function (aggregation) {
        ...
        extend(query.aggregations, aggregation.toJSON());
