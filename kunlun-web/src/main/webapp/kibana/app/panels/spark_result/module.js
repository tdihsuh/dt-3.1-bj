...
define([
    ...
    function(angular, app, _, kbn, moment) {
        ...
        var module = angular.module('kibana.panels.spark_result', []);
        app.useModule(module);

        module.controller('spark_result', function($rootScope, $scope, $modal, $q, $compile, $timeout,
            ...
            $scope.panelMeta = {
                ...
                editorTabs: [{
                    title: '分页',
                    src: 'app/panels/spark_result/pagination.html'
                }, {
                    title: '查询',
            ...
            $scope.get_data = function(segment, query_id) {
                ...
                var results = JSON.parse('[{"@version":"1","@timestamp":"2011-07-28T14:08:47.000Z","clientip":"164.82.146.3","ident":"-","auth":"-","timestamp":"28/Jul/2011:07:08:47 -0700","verb":"GET","request":"/sitebuilder/images/navigationbar-4-inactive-76152.png","httpversion":"1.1","response":"200","bytes":"1097","referrer":"http://plannedpethoodrockymount.com/","agent":"Mozilla/4.0 (compatible; MSIE 7.0; Windows NT 5.1; .NET CLR 1.1.4322; .NET CLR 2.0.50727; InfoPath.1)"},{"@version":"1","@timestamp":"2011-07-28T14:08:48.000Z","clientip":"164.82.146.3","ident":"-","auth":"-","timestamp":"28/Jul/2011:07:08:48 -0700","verb":"GET","request":"/sitebuilder/images/navigationbar-3-mouseOver-43908.png","httpversion":"1.1","response":"200","bytes":"761","referrer":"http://plannedpethoodrockymount.com/","agent":"Mozilla/4.0 (compatible; MSIE 7.0; Windows NT 5.1; .NET CLR 1.1.4322; .NET CLR 2.0.50727; InfoPath.1)"}]');
                {
                    ...
                    if ($scope.query_id === query_id) {
                        ...
                        $scope.data = $scope.data.concat(_.map(results, function(hit) {
                            var
                                _h = _.clone(hit),
