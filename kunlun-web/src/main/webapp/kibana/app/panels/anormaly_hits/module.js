...
define([
    ...
    var module = angular.module('kibana.panels.anormaly_hits', []);
    app.useModule(module);

    module.controller('anormaly_hits', function($scope, querySrv, dashboard, filterSrv) {
        $scope.panelMeta = {
            modals: [{
                description: "查看",
                icon: "icon-info-sign",
        ...
        $scope.get_data = function(segment, query_id) {
            ...
            var ids = ["anormal"];
            var request = $scope.ejs.Request().indices(ids);
