...
define([
    ...
    function(angular, app, _, kbn, moment) {
        ...
        var module = angular.module('kibana.panels.anormaly_table', []);
        app.useModule(module);

        module.controller('anormaly_table', function($rootScope, $scope, $modal, $q, $compile, $timeout,
            ...
            $scope.panelMeta = {
                ...
                editorTabs: [{
                    title: '分页',
                    src: 'app/panels/anormaly_table/pagination.html'
                }, {
                    title: '查询',
                    src: 'app/partials/querySelect.html'
                }],
                status: "Beta",
                description: "显示异常事件纪录详细信息"
            };
