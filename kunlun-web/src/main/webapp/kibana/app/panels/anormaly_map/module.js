...
define([
    ...
    function(angular, app, _, $) {
        ...
        var module = angular.module('kibana.panels.anormaly_map', []);
        app.useModule(module);

        module.controller('anormaly_map', function($scope, $rootScope, querySrv, dashboard, filterSrv) {
            $scope.panelMeta = {
                editorTabs: [{
                    title: '查询',
                ...
                status: "Beta",
                description: "显示查询异常时间结果中的IP地域分布"
            };
