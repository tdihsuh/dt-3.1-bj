...
define([
    ...
    function(angular, app, _, $, kbn) {
        ...
        var module = angular.module('kibana.panels.anormaly_terms', []);
        app.useModule(module);

        module.controller('anormaly_terms', function($scope, querySrv, dashboard, filterSrv, fields) {
            $scope.panelMeta = {
                modals: [{
                    description: "查看",
                    icon: "icon-info-sign",
