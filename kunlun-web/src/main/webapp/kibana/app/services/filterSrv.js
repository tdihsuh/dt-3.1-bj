define([
  ...
  module.service('filterSrv', function(dashboard, ejsResource, $rootScope, $timeout) {
    ...
    this.refresh_dashboard = function() {
      dashboard.refresh();
    }

    // This is used both for adding filters and modifying them.
    // If an id is passed, the filter at that id is updated
    this.set = function(filter,id,noRefresh,debounce) {
      var _r;
      ...
      if(noRefresh !== true) {
        $timeout(this.refresh_dashboard,0);
      } else if (debounce == true) {
        var lazy = _.debounce(this.refresh_dashboard, 1000, 
